                                        ...
                                        <form action="#">
                                            <div className="clearfix" style={{zIndex:"1000"}}>
                                                ...
                                                <div className="product_quantity clearfix">
                                                    <span>Quantity: </span>
                                                    <input id="quantity_input" type="text" pattern="[0-9]*" defaultValue="1"></input>
                                                ...
                                                <ul className="product_color">
                                                    <li>
                                                        ...
                                                        <ul className="color_list">
                                                            <li><div className="color_mark" style={{background:"red"}}></div></li>
                                                            <li><div className="color_mark" style={{background:"blue"}}></div></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </div>
